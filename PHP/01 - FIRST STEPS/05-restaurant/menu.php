...
<head>
    <meta charset="utf-8" />
    <title>Chef’s Tasting Menu</title>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .menu > div:first-child{
            text-align:center; padding:40px 28px 24px;
        ...
        h1{
            margin:.2rem 0; font-size:1.9rem; letter-spacing:.06em; font-weight:800;
            text-transform:uppercase;
        }
        .subtitle{color:var(--muted); font-size:.98rem}
        .wrap{display:grid; gap:28px; padding:28px}
        section{
            padding:20px 22px; border:1px solid var(--rule); border-radius:16px;
            background: rgba(255,255,255,.01);
        }
        h2{
            margin:0 0 10px; font-size:1.15rem; text-transform:uppercase; letter-spacing:.14em; color:var(--gold);
        }
        .course{display:grid; gap:6px; padding:14px 0; border-top:1px dashed var(--rule)}
        .course:first-of-type{border-top:none; padding-top:0}
        .title{font-weight:700; font-size:1.05rem}
        .desc{color:var(--muted)}
        .pair{font-style:italic; color:#cfd5e1}
        .grid{
        ...
        .item{display:flex; justify-content:space-between; gap:16px; border-top:1px dashed var(--rule); padding-top:10px}
        .item:first-child{border-top:none; padding-top:0}
        .name{font-weight:600}
        .note{color:var(--muted)}
        footer{
            border-top:1px solid var(--rule);
            padding:16px 22px; color:var(--muted); font-size:0.9rem; text-align:center;
        }
        @media print{
            body{background:white; padding:0}
            .menu{box-shadow:none; border:none; border-radius:0}
            header, footer, section{break-inside:avoid}
        ...
        <div class="grid">
            <section>
                ...
                <div class="course">
                    ...
                    <div class="desc">Served on crushed ice with cucumber granita, citrus foam &amp; ponzu pearls.</div>
            ...
            <section>
                ...
                <ul class="list" aria-label="Wine List">
                    <li class="item"><span class="name">White</span><span class="note">Chablis Premier Cru, Domaine Laroche</span></li>
                    <li class="item"><span class="name">Red</span><span class="note">Brunello di Montalcino, Castiglion del Bosco</span></li>
                    <li class="item"><span class="name">Rosé</span><span class="note">Whispering Angel, Côtes de Provence</span></li>
                    <li class="item"><span class="name">Sparkling</span><span class="note">Dom Pérignon Vintage 2013</span></li>
                </ul>

                <h3 class="title" style="margin-top:18px">Cocktails</h3>
                <ul class="list" aria-label="Cocktail List">
                    <li class="item"><span class="name">Elderflower Martini</span><span class="note">Gin, St-Germain, lemon twist</span></li>
                    <li class="item"><span class="name">Smoked Old Fashioned</span><span class="note">Bourbon, smoked syrup, orange zest</span></li>
                    <li class="item"><span class="name">Cucumber Cooler</span><span class="note">Vodka, mint, cucumber &amp; tonic</span></li>
                </ul>

                <h3 class="title" style="margin-top:18px">Non-Alcoholic</h3>
                <ul class="list" aria-label="Non-alcoholic List">
                    <li class="item"><span class="name">Sparkling Elderflower Water</span><span class="note">Floral &amp; refreshing</span></li>
                    <li class="item"><span class="name">Cold-Pressed Apple &amp; Ginger</span><span class="note">Bright, lightly spicy</span></li>
                    <li class="item"><span class="name">Jasmine Iced Tea</span><span class="note">Hand-brewed, delicate aroma</span></li>
                </ul>
            </section>
        </div>
    </div>
